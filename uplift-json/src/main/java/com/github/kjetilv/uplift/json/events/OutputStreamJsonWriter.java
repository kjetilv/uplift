...
class OutputStreamJsonWriter<T extends Record, B> extends AbstractJsonWriter<T, ByteArrayOutputStream, byte[]> {

    OutputStreamJsonWriter(ObjectWriter<T> objectWriter) {
        super(objectWriter);
    }
