...
/// @param <H> Key type, used as the key type in stored maps
/// @see MapsMemoizers
@SuppressWarnings("unused")
public interface MapsMemoizer<I, H> extends MemoizedMaps<I, H> {
    ...
    /// @return Lookup of canonical maps
    MemoizedMaps<I, H> maps(boolean copy);
}
