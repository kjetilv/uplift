...
/**
 * Indexing interface.  {@link #exchange(Object) Indexes} each object to a unique long, and allows
 * later {@link #exchange(long) retrieval} of the object.
 *
 * @param <T>
 */
interface Indexer<T> {
     ...
     *
     * @param index Unique long, previously returned by {@link #exchange(Object) mapping}
